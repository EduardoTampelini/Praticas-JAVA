...
public class FacecTampeliniProvaApplication implements CommandLineRunner{

	public static void main(String[] args) {
		SpringApplication.run(FacecTampeliniProvaApplication.class, args);
	}
	@Autowired
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli3 = new Cliente("Jotaro Kujo", "15049632021","jojoSC@teste","Rua de terrao");
		Cliente cli4 = new Cliente("Josuke Hishigata", "04391920050","jojoDB@teste","Rua de paralelepipedo");
		Cliente cli5 = new Cliente("Giorno Giovana", "30652004067","jojoGW@teste","Rua de terra roxa");
		clirepo.save(cli2);
		clirepo.save(cli3);
		clirepo.save(cli4);
		clirepo.save(cli5);
